...
if state = 0{
    if house = 0 and Pac.start = 0 and global.boost = 2 and !collision_point(tilex,tiley,Slow,false,true){
        if dir = 1{draw_sprite_ext(spr_boostlines,5,x,y,1,1,0,make_color_rgb(255,184,255),1)};
        else{if dir = 3{draw_sprite_ext(spr_boostlines,6,x,y+(global.plus*floor(global.game/2)*8),1,1,0,make_color_rgb(255,184,255),1)};
        else{draw_sprite_ext(spr_boostlines,dir,x,y+(global.plus*floor(global.game/2)*8),1,1,0,make_color_rgb(255,184,255),1)}
        }}
if global.otto = 0{
    if Pac.start = false{draw_sprite_ext(spr_Ghost,(floor(im/8))+(floor((global.plus+(global.game/2))/2))*6,x,y,1,1,0,make_color_rgb(255,184,255),1)}
    else{draw_sprite_ext(spr_Ghost,0+(floor((global.plus+(global.game/2))/2))*6,x,y,1,1,0,make_color_rgb(255,184,255),1);}
}
else{
    if Pac.start = false{draw_sprite_ext(spr_OttoMon,(floor(im/8))+(2*dir),x,y,1,1,0,make_color_rgb(255,184,255),1);
    draw_sprite(spr_OttoMon,(floor(im/8))+(2*dir)+8,x,y);}
    else{draw_sprite_ext(spr_OttoMon,4+2,x,y,1,1,0,make_color_rgb(255,184,255),1);
...
if Pac.start = false{if global.game = 2 and global.plus = 1{
...
if state = 0{
if global.otto = 0{
    if Pac.start = false{draw_sprite_ext(spr_Ghost,(floor(im/8))+(floor((global.plus+(global.game/2))/2))*6,x,y+512,1,1,0,make_color_rgb(255,184,255),1)}
    else{draw_sprite_ext(spr_Ghost,0+(floor((global.plus+(global.game/2))/2))*6,x,y+512,1,1,0,make_color_rgb(255,184,255),1);}
}
else{
    if Pac.start = false{draw_sprite_ext(spr_OttoMon,(floor(im/8))+(2*dir),x,y+512,1,1,0,make_color_rgb(255,184,255),1);
    draw_sprite(spr_OttoMon,(floor(im/8))+(2*dir)+8,x,y+512);}
    else{draw_sprite_ext(spr_OttoMon,4+2,x,y+512,1,1,0,make_color_rgb(255,184,255),1);
