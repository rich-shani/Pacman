...
if global.lvl > 4 or global.plus = true{oGameManager.sp = 2.375; spslow = 1.25; spfright = 1.5;}
}
else{
{oGameManager.sp = 2.125; spslow = 1.125; spfright = 1.375; spelroy = 2.25;}
if global.lvl > 2 or global.plus = true{oGameManager.sp = 2.375; spslow = 1.25; spfright = 1.5;}
}
speyes = 4;
