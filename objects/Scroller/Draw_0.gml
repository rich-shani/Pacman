...
__b__ = action_if_variable(Pac.start, 0, 0);
if __b__
{
{
...
action_draw_variable(Pac.cycle, __view_get( e__VW.XView, 0 ) + 384, __view_get( e__VW.YView, 0 ) + 32);
action_draw_variable(Pac.scatter, __view_get( e__VW.XView, 0 ) + 384 + 16, __view_get( e__VW.YView, 0 ) + 32);
action_color(255);
