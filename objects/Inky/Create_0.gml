...
/// ===============================================================================
/// Description: Initializes Inky (Bashful/Cyan Ghost)
/// Personality: Unpredictable - uses complex vector calculation based on Blinky
...
/// Target pursuit X coordinate (calculated using Blinky position + offset)
pursuex = 0;
...
state = 0;
/// Elroy threshold: when dots <= this value, Inky enters faster "Elroy" pursuit mode
elroydots = 244;
/// Corner X for scatter mode (bottom-right corner)
cornerx = 416;
/// Corner Y for scatter mode (bottom-right corner)
cornery = 416;
