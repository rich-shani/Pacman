...
if house = 0 and state = 2 and x > (xstart - 184) + 212 and x < (xstart - 184) +  220 and y = (ystart - 272) + 224{housestate=0;

    x = (xstart - 184) + 216; y = (ystart - 272) + 224; hspeed = 0; vspeed = speyes; house = 1; dir = 3;}

if house = 1 and state = 2 and x = (xstart - 184) + 216 and y > (ystart - 272) + 272 + 8{housestate=1; x = (xstart - 184) + 216; y = (ystart - 272) + 272 + 8;}

if housestate = 1{hspeed = -speyes; vspeed = 0; dir = 2;

    if x < (xstart - 184) +  184 {housestate = 2; state = 0; x = (xstart - 184) + 184; dir = 1;}
...
if housestate = 3{hspeed = spslow; vspeed = 0; dir = 0;

    if x > (xstart - 184) + 216 {housestate = 4; x = (xstart - 184) + 216;}
