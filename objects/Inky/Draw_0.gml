...
if global.otto = 0{
    if Pac.start = false{draw_sprite_ext(spr_Ghost,(floor(im/8))+(floor((global.plus+(global.game/2))/2))*6,x,y,1,1,0,make_color_rgb(0,255,255),1)}
    else{draw_sprite_ext(spr_Ghost,0+(floor((global.plus+(global.game/2))/2))*6,x,y,1,1,0,make_color_rgb(0,255,255),1);}
}
else{
    if Pac.start = false{draw_sprite_ext(spr_OttoMon,(floor(im/8))+(2*dir),x,y,1,1,0,make_color_rgb(0,255,255),1);
...
if state = 0{
if global.otto = 0{
    if Pac.start = false{draw_sprite_ext(spr_Ghost,(floor(im/8))+(floor((global.plus+(global.game/2))/2))*6,x,y-512,1,1,0,make_color_rgb(0,255,255),1)}
    else{draw_sprite_ext(spr_Ghost,0+(floor((global.plus+(global.game/2))/2))*6,x,y-512,1,1,0,make_color_rgb(0,255,255),1);}
}
else{
    if Pac.start = false{draw_sprite_ext(spr_OttoMon,(floor(im/8))+(2*dir),x,y-512,1,1,0,make_color_rgb(0,255,255),1);
