with Wall{
    ...
    if y = 480{
        if x = 96{image_index = 21}
        if x = 336{image_index = 24}
    }
    if y = 512{
        if x = 208{image_index = 36}
        if x = 224{image_index = 39}
    }
    if y = 528{
        if x = 208{image_index = 5}
        if x = 224{image_index = 8}
    }
}
if global.rand = 0{
global.mr = 0
...
if global.game = 1{
if irandom(1) = 1{global.ex1 = 112};else{global.ex1 = 272}
