...
function movement2() {
	...
	////control
	if dead = 0 and oGameManager.start = 0 and oGameManager.finish = 0 and stoppy2 = 0 and bonked2 = 0{
	if global.lvl > 0{
	    ...
	    if keyboard_check(ord("D"))=true and keyboard_check(ord("W"))=false and keyboard_check(ord("A"))=false and keyboard_check(ord("S"))=false{
	        if !collision_point(16*(round((x2)/16))+17,16*(round((y2)/16)),Wall,false,true){dir2= 0; park2 = -1
	            if direction2 = 90{//up to right  
	                if y2 > 16*round((y2)/16){corner2 = 1; hspeed2 = oGameManager.sp; vspeed2 = -oGameManager.sp; exit} // preturn up
	                else{corner2 = 2; hspeed2 = oGameManager.sp; vspeed2 = oGameManager.sp; exit} // postturn up
	            }
	            else{if direction2 = 270{//down to right
	                if y2 < 16*round((y2)/16){corner2 = 2; hspeed2 = oGameManager.sp; vspeed2 = oGameManager.sp; exit} // preturn down
	                else{corner2 = 1; hspeed2 = oGameManager.sp; vspeed2 = -oGameManager.sp; exit} // postturn down
	            }
	            else{hspeed2 = oGameManager.sp; vspeed2 = 0} //left or right to right
	        }}
	    ...
	    if keyboard_check(ord("W"))=true and keyboard_check(ord("D"))=false and keyboard_check(ord("A"))=false and keyboard_check(ord("S"))=false{
	        if !collision_point(16*(round((x2)/16)),16*(round((y2)/16))-1-0,Wall,false,true){dir2= 1; park2 = -1
	            if direction2 = 0 and !hspeed2 = 0{ //right to up
	                if x2 < 16*round((x2)/16){corner2 = 3; hspeed2 = oGameManager.sp; vspeed2 = -oGameManager.sp; exit} // preturn right
	                else{corner2 = 4; hspeed2 = -oGameManager.sp; vspeed2 = -oGameManager.sp; exit} // postturn right
	            }
	            else{if direction2 = 180{//left to up
	                if x2 > 16*round((x2)/16){corner2 = 4; hspeed2 = -oGameManager.sp; vspeed2 = -oGameManager.sp; exit} // preturn left
	                else{corner2 = 3; hspeed2 = oGameManager.sp; vspeed2 = -oGameManager.sp; exit} // postturn left
	            }
	            else{hspeed2 = 0; vspeed2 = -oGameManager.sp} //down or up to up
	        }}
	    ...
	    if keyboard_check(ord("A"))=true and keyboard_check(ord("W"))=false and keyboard_check(ord("D"))=false and keyboard_check(ord("S"))=false{
	        if !collision_point(16*(round((x2)/16))-1-0,16*(round((y2)/16)),Wall,false,true){dir2= 2; park2 = -1
	            if direction2 = 90{//up to left
	                if y2 > 16*round((y2)/16){corner2 = 5; hspeed2 = -oGameManager.sp; vspeed2 = -oGameManager.sp; exit} // preturn up
	                else{corner2 = 6; hspeed2 = -oGameManager.sp; vspeed2 = oGameManager.sp; exit} // postturn up
	            }
	            else{if direction2 = 270{//down to left
	                if y2 < 16*round((y2)/16){corner2 = 6; hspeed2 = -oGameManager.sp; vspeed2 = oGameManager.sp; exit} // preturn down
	                else{corner2 = 5; hspeed2 = -oGameManager.sp; vspeed2 = -oGameManager.sp; exit} // postturn down
	            }
	            else{hspeed2 = -oGameManager.sp; vspeed2 = 0} //left or right to left
	        }}
	    ...
	    if keyboard_check(ord("S"))=true and keyboard_check(ord("D"))=false and keyboard_check(ord("A"))=false and keyboard_check(ord("W"))=false{
	        if !collision_point(16*(round((x2)/16)),16*(round((y2)/16))+17,Wall,false,true){dir2= 3; park2 = -1
	            if direction2 = 0 and !hspeed2 = 0{ //right to down
	                if x2 < 16*round((x2)/16){corner2 = 7; hspeed2 = oGameManager.sp; vspeed2 = oGameManager.sp; exit} // preturn right
	                else{corner2 = 8; hspeed2 = -oGameManager.sp; vspeed2 = oGameManager.sp; exit} // postturn right
	            }
	            else{if direction2 = 180{//left to down
	                if x2 > 16*round((x2)/16){corner2 = 8; hspeed2 = -oGameManager.sp; vspeed2 = oGameManager.sp; exit} // preturn left
	                else{corner2 = 7; hspeed2 = oGameManager.sp; vspeed2 = oGameManager.sp; exit} // postturn left
	            }
	            else{hspeed2 = 0; vspeed2 = oGameManager.sp} //down or up to down
	        }}
