...
function step() {
	...
	if oGameManager.fright = 1{
	            if dir2 = 0{hspeed2 = oGameManager.spfright; vspeed2 = 0;}
	            if dir2 = 1{hspeed2 = 0; vspeed2 = -oGameManager.spfright;}
	            if dir2 = 2{hspeed2 = -oGameManager.spfright; vspeed2 = 0;}
	            if dir2 = 3{hspeed2 = 0; vspeed2 = oGameManager.spfright;}
	            }
	            else{ 
	            if dir2 = 0{hspeed2 = oGameManager.sp; vspeed2 = 0;}
	            if dir2 = 1{hspeed2 = 0; vspeed2 = -oGameManager.sp;}
	            if dir2 = 2{hspeed2 = -oGameManager.sp; vspeed2 = 0;}
	            if dir2 = 3{hspeed2 = 0; vspeed2 = oGameManager.sp;}
	            }
	}
	...
	if corner2 = 0 and eatdir2 = -1 and oGameManager.finish = 0 and dead = 0 and chomp = 0{
